...
__global__ void mmaOBTKernelSparse_large(half *bcsrValuesA, int *bcsrRowPtrA,
...
void mmaOBTKernel_large(half *bcsrValuesA, int *bcsrRowPtrA, int *bcsrColIdxA,
  ...
  mmaOBTKernelSparse_large<<<grid, block>>>(
